package AI::OpenAPI::ChatCompletionRequestMessageContentPart 0.01;
...
AI::OpenAPI::ChatCompletionRequestMessageContentPart -

=head1 SYNOPSIS

  my $obj = AI::OpenAPI::ChatCompletionRequestMessageContentPart->new($args);
  ...
